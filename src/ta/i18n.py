...
MENSAGENS: dict[str, dict[str, str]] = {
    ...
    "horizon.vencida": {"pt": "vencidas", "en": "overdue"},
    "horizon.hoje": {"pt": "hoje", "en": "today"},
    "horizon.semana": {"pt": "próximos 7 dias", "en": "next 7 days"},
    "horizon.depois": {"pt": "depois e sem prazo", "en": "later and undated"},
